...
- Planning docs for the proposed auditable ledger feature live in `docs/auditable-ledger-master-plan.md`,
  `docs/auditable-ledger-phase-1-plan.md`, `docs/auditable-ledger-phase-2-plan.md`, and `docs/auditability-ui-plan.md`.
...
- Add ledger API shape through `src/main/resources/openapi/home-budget-api.yaml` first. Likely endpoints are
  `GET /ledger/head`, `GET /ledger/verify`, and `GET /operations/{operationId}/proof`.
