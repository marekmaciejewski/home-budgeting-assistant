...
- Planning docs for the proposed auditable ledger feature live in `docs/auditable-ledger-master-plan.md`,
  `docs/auditable-ledger-phase-1-plan.md`, `docs/auditable-ledger-phase-2-plan.md`,
  `docs/auditability-ui-plan.md`, `docs/auditable-ledger-phase-3-session-prompt.md`, and
